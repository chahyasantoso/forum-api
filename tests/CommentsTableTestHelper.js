...
const CommentsTableTestHelper = {
  async addComment({
    id = 'comment-123', content = 'a comment', date = new Date('2023-01-01'), threadId = 'thread-123', owner = 'user-123', isDelete = false,
  }) {
    const query = {
  ...
  async addReply({
    id = 'reply-123', content = 'a reply', date = new Date('2023-01-01'),
